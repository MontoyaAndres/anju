...
const CHANNEL_STATUS_ACTIVE = 'active';
const CHANNEL_STATUS_DISABLED = 'disabled';
const CHANNEL_STATUSES = [CHANNEL_STATUS_ACTIVE, CHANNEL_STATUS_DISABLED];
...
const CHANNEL_MESSAGE_ROLE_USER = 'user';
const CHANNEL_MESSAGE_ROLE_ASSISTANT = 'assistant';
const CHANNEL_MESSAGE_ROLE_SYSTEM = 'system';
const CHANNEL_MESSAGE_ROLE_TOOL = 'tool';
const CHANNEL_MESSAGE_ROLES = [
  CHANNEL_MESSAGE_ROLE_USER,
  CHANNEL_MESSAGE_ROLE_ASSISTANT,
  CHANNEL_MESSAGE_ROLE_SYSTEM,
  CHANNEL_MESSAGE_ROLE_TOOL
];

const CHANNEL_USAGE_KIND_PROMPT = 'prompt';
const CHANNEL_USAGE_KIND_RESOURCE = 'resource';
const CHANNEL_USAGE_KIND_TOOL = 'tool';
